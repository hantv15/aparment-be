...
@section('content')
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <div class="btn-group">
                <a  href="{{route('admin-technicians.add')}}" class="btn btn-success">Thêm quản trị viên mới</a>
                &nbsp  &nbsp  &nbsp
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                    ...
                                    <a href="{{route('admin-technicians.edit', ['id' => $user->id])}}" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit"><i class="bi bi-pencil-fill"></i></a>
                                    <a href="{{route('admin-technicians.remove', ['id' => $user->id])}}" class="text-danger" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Delete"><i class="bi bi-trash-fill"></i></a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
